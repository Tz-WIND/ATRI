...
GRAPH_RETRIEVAL_DEFAULT_DEPTH = 3
GRAPH_RETRIEVAL_MAX_DEPTH = 7
GRAPH_EXPANSION_CANDIDATE_MAX_LIMIT = 1000
GRAPH_CYPHER_QUERY_TIMEOUT_SECONDS = 60
GRAPH_RETRIEVAL_TIMEOUT_SECONDS = 15
GRAPH_EXTRACTION_TIMEOUT_SECONDS = 120
...
SOURCE_SCOPE_EXACT = "exact"
SOURCE_SCOPE_INFERRED = "inferred"
SOURCE_SCOPE_BATCH_FALLBACK = "batch_fallback"
SOURCE_SCOPE_LEGACY = "legacy"
